...
# =============================================================================
# COR PADRÃO DO MODELO (CONFIGURÁVEL)
# =============================================================================
DEFAULT_MODEL_COLOR = (0.7, 0.75, 0.8, 1.0)

# =============================================================================
# CORES ALTERNATIVAS PARA DALTONISMO
# =============================================================================
COLORBLIND_FRIENDLY_COLORS = {
    'default': (0.7, 0.75, 0.8, 1.0),      # Cinza azulado
    'deuteranopia': (0.2, 0.6, 0.9, 1.0),  # Azul
    'protanopia': (0.9, 0.6, 0.2, 1.0),    # Laranja
    'tritanopia': (0.9, 0.2, 0.5, 1.0),    # Rosa
}